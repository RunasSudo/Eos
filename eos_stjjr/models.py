...
class ElectionWithTrustees(eos_core.models.Election):
	class EosMeta:
		...
		eos_fields = eos_core.models.Election._eosmeta.eos_fields + [
...
class Trustee(eos_core.models.EosDictObjectModel):
	class EosMeta:
		...
		eos_fields = [
			...
			eos_core.libobjects.EosField(ElectionWithTrustees, 'election', on_delete='CASCADE'),
...
class DjangoAuthTrustee(Trustee):
	class EosMeta:
		abstract = True
		eos_fields = Trustee._eosmeta.eos_fields + [
...
class STJJRTrustee(DjangoAuthTrustee):
	class EosMeta:
		...
		eos_fields = DjangoAuthTrustee._eosmeta.eos_fields + [
			eos_core.libobjects.EosField(eos_stjjr.crypto.CPSEGPublicKey, 'public_key'),
		]
