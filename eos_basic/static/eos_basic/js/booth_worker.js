...
onmessage = function(msg) {
	if (!isLibrariesLoaded) {
		importScripts(
			msg.data.static_base_url + "eos_basic/js/eos_json.js",
			msg.data.static_base_url + "eos_basic/js/jssha-sha256.js",
			msg.data.static_base_url + "eos_basic/js/build/eos_js.js"
		);
		isLibrariesLoaded = true;
	}
	
	if (msg.data.action === "generateEncryptedVote") {
		msg.data.election = eos_js.eos_core.libobjects.__all__.EosObject.deserialise_and_unwrap(msg.data.election, null);
